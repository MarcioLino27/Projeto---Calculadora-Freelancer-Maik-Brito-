...
<header class="page-header bg-gray-700 text-white p-8">
  <div class="max-w-4xl mx-auto">
    <section id="top"class="animate-up flex justify-between items-center border-b border-b-gray-600 pb-8">
      ...
      <button
        on:click={goToProfile} id="avatar-profile" class="flex items-center gap-4 hover:text-orange-400 transition">
    ...
    <section id="summary"class="animate-up delay-1 flex justify-between items-center">
      ...
      <button
        on:click={goToProject} class="button orange uppercase flex gap-4 bg-orange-400 h-fit px-3 py-2 rounded items-center hover:brightness-110 transition-all"
      >
