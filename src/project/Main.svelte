...
<main>
  ...
  <div class="space-y-4">
    <div class="grid gap-3">
      ...
      >
      <input
        class="px-4 py-2 border rounded-sm text-sm" type="text" id="name" name="name"
    ...
    <div class="flex gap-4">
      <div class="grid gap-3">
        ...
        >
        <input
          class="px-4 py-2 border rounded-sm text-sm" type="number" step="0.5" id="daily-hours" name="daily-hours"
      ...
      <div class="grid gap-3">
        ...
        >
        <input
          class="px-4 py-2 border rounded-sm text-sm" type="number" id="total-hours" name="total-hours"
