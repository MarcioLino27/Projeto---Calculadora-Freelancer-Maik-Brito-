...
<div class="container animate-up delay-2 flex justify-between p-12 max-w-4xl mx-auto">
  <Aside>
    ...
    <p class="text-center mt-4 text-gray-600">O valor da sua hora é <br />
  ...
  <main>
    ...
    <div class="flex gap-4">
      <div class="grid gap-3">
        ...
        <input class="px-4 py-2 border rounded-sm text-sm" type="text" id="name" name="name"
    ...
    <div class="flex gap-4">
      <div class="grid gap-3">
        ...
        <input class="px-4 py-2 border rounded-sm text-sm" type="amount" step="0.1" id="monthly-budget" name="monthly-budget" placeholder="R$"
          bind:value={$app.planning.monthlyIncome}/>
      </div>

      <div class="grid gap-3">
        <label class="text-gray-500 font-medium text-sm" for="hours-per-day">Quantas horas <br />quero trabalhar por dia?</label>
        <input class="px-4 py-2 border rounded-sm text-sm" type="number" id="hours-per-day" name="hours-per-day"
    ...
    <div class="flex gap-4 mt-4">
      <div class="grid gap-3">
        ...
        <input class="px-4 py-2 border rounded-sm text-sm" type="number" id="days-per-week" name="days-per-week"
          bind:value={$app.planning.daysAWeek}/>
      </div>

      <div class="grid gap-3">
        <label class="text-gray-500 font-medium text-sm" for="vacation-per-year">Quantas semanas <br />por ano você quer tirar férias?</label>
        <input
          class="px-4 py-2 border rounded-sm text-sm" type="number" id="vacation-per-year" name="vacation-per-year" 
